...
gg.__namecall = newcclosure(function(...)
 ...
 args[2] = PositionSkillFishyDevilFruit
 else
   args[2] = CFrame.new(PositionSkillFishyDevilFruit)
 end
...
ImageButton.Image = "rbxassetid://886719070"

UICorner.CornerRadius = UDim.new(0, 30)
UICorner.Parent = ImageButton

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 255)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(0, 0, 255)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(0, 0, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(96, 255, 231))}
...
function CheckQuest() 
    ...
    if World1 then
		...
		elseif MyLevel == 150 or MyLevel <= 174 or _G.Select_Mob_Farm == "Sky Bandit" then -- Sky Bandit
			...
			SPAWNPOINT = "Sky"
		elseif MyLevel == 175 or MyLevel <= 189 or _G.Select_Mob_Farm == "Dark Fish" then -- Dark Fish
			Ms = "Dark Fish"
			NameQuest = "SkyQuest"
			LevelQuest = 2
			NameMon = "Dark Fish"
...
function checkselect() 
    ...
    if World1 then
		...
		elseif MyLevel == 150 or MyLevel <= 174 or SelectMonster == "Sky Bandit" then -- Sky Bandit
			...
			CFrameMon = CFrame.new(-4970.74219, 294.544342, -2890.11353, -0.994874597, -8.61311236e-08, -0.101116329, -9.10836206e-08, 1, 4.43614923e-08, 0.101116329, 5.33441664e-08, -0.994874597)
			--Spawn = "Sky"
		elseif MyLevel == 175 or MyLevel <= 189 or SelectMonster == "Dark Fish" then -- Dark Fish
			Mon = "Dark Fish"
			--NameQuest = "SkyQuest"
			LevelQuest = 2
			NameMon = "Dark Fish"
...
spawn(function()
	...
	gg.__namecall = newcclosure(function(...)
		...
		if tostring(method) == "FireServer" then
			if tostring(args[1]) == "RemoteEvent" then
				if tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then
					if UseSkillFishyDevilFruit then
						args[2] = PositionSkillFishyDevilFruit
						return old(unpack(args))
...
--------------------------------------------------------------------
local Library = Update:Window("Fish","")
------------------------------------------
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function() CheckQuest()
		pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.Auto_Farm_Level and FishyBFStartMagnetActive and v.Name == Ms and (v.HumanoidRootPart.Position - PosMonFishyFruit.Position).magnitude <= 350 then
					v.HumanoidRootPart.CFrame = PosMonFishyFruit
					v.HumanoidRootPart.CanCollide = false
					v.HumanoidRootPart.Size = Vector3.new(50,50,50)
					if v.Humanoid:FindFirstChild("Animator") then
						v.Humanoid.Animator:Destroy()
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function() CheckQuest()
		pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.Auto_Farm_Level and FishyGunStartMagnetActive and v.Name == Ms and (v.HumanoidRootPart.Position - PosMonFishyGun.Position).magnitude <= 350 then
					v.HumanoidRootPart.CFrame = PosMonFishyGun
					v.HumanoidRootPart.CanCollide = false
					v.HumanoidRootPart.Size = Vector3.new(50,50,50)
					if v.Humanoid:FindFirstChild("Animator") then
						v.Humanoid.Animator:Destroy()
...
if World1 then
tableMon = {
 "Bandit","Monkey","Gorilla","Pirate","Brute","Desert Bandit","Desert Officer","Snow Bandit","Snowman","Chief Petty Officer","Sky Bandit","Dark Fish","Prisoner", "Dangerous Prisoner","Toga Warrior","Gladiator","Military Soldier","Military Spy","Fishman Warrior","Fishman Commando","God's Guard","Shanda","Royal Squad","Royal Soldier","Galley Pirate","Galley Captain"
} elseif World2 then
tableMon = {
...
-- Main:Toggle("Auto Farm ThĂ´ng Thà£o Sùng",_G.AutoFarmGunFishy,function(value)
--  _G.AutoFarmGunFishy = value
 -- StopTween(_G.AutoFarmGunFishy)
 -- end)
 
 spawn(function()
  pcall(function()
   while wait() do
   if _G.AutoFarmGunFishy then
   ...
   if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
   StartFishyGunStartMagnet = false
   CheckQuest()
   topos(CFrameQuest)
   ...
   pcall(function()
    ...
    StartFishyGunStartMagnet = true
    PosMonFishyGun = v.HumanoidRootPart.CFrame
    else
     StartFishyGunStartMagnet = false
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    end
    until v.Humanoid.Health <= 0 or _G.AutoFarmGunFishy == false or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
    StartFishyGunStartMagnet = false
    end
    end
    end)
...
--else
--_G.Kill_At = 25
--Main:Slider1("Kill Health [For Fishy]",1,100,25,function(value)
-- _G.Kill_At = value
--end)
--end
...
for k,v in pairs(allitem) do 
    ...
    for k,v in pairs(v) do 
        if Items[v.ItemName.Text] and Items[v.ItemName.Text].Fishy then 
            if v.ItemLine2.Text~="Accessory" then 
                ...
                bucac.ZIndex  = 5
                bucac.Text = Items[v.ItemName.Text].Fishy
